...
if($_SERVER['REQUEST_METHOD']=='POST')
{
	...
	try {
	  ...
	  $stmt = $conn->prepare("INSERT INTO users (user_firstname,user_lastname,user_name,user_email,user_password,user_location)


	  VALUES (:user_firstname,:user_lastname,:user_name,:user_email,:user_password,:user_location)");


	  $password=md5($_POST['password']);
	  $stmt->bindParam(':user_firstname',$_POST['firstname']);
	  $stmt->bindParam(':user_lastname',$_POST['lastname']);
	  $stmt->bindParam(':user_name', $_POST['username']);
	  $stmt->bindParam(':user_email', $_POST['email']);
	  $stmt->bindParam(':user_password',$password);
	  $stmt->bindParam(':user_location', $_POST['country']);
	  //$stmt->bindParam(':user_birthdate', "");
